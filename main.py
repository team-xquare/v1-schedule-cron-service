...
def start_macro():
    with session_scope() as session:
        ...
        lists = requests.get(
            f"https://open.neis.go.kr/hub/SchoolSchedule?ATPT_OFCDC_SC_CODE=G10&SD_SCHUL_CODE=7430310&pSize=1000&KEY=c03fd226bdfe4cbbbca67a26d9176432&Type=json&AA_FROM_YMD={start_at}&AA_TO_YMD={end_at}").json()
